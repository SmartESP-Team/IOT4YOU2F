...
const HomePage = () => {
 ...
 const validTesterIds = [
  ...
  const generateCustomCode = async () => {
    ...
    try {
      const componentList = selectedComponentsForAI
        ...
        <div className="mb-8 p-6 glass-card rounded-3xl">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Composants sélectionnés ({selectedComponentsForAI.length})
            </label>
      ...
      <div className="text-center">
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-12 rounded-2xl">
          ...
          <p className="text-xl mb-8 opacity-90">
            ...
            Rejoins notre communauté de passionnés d’IoT, d’Arduino et de tech.
Ici, on apprend, on crée et on partage nos projets ensemble, du concept jusqu’à la mise en marche. 💡🔧
          ...
          >
           Connecte-toi à des makers, codeurs pour concrétiser votre projet sans stress et en t'amusant ✅
          </a>
        </div>
      </div>
    </div>
